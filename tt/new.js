    ...
    try {
        ...
        function need_project_config(_12) {
            ...
            try {
                ...
                if (_sessionStorageGetConfig("sc_project_config_" + _12) !== null && _sessionStorageGetConfig("sc_project_time_difference_" + _12) !== null) {
                    ret = false
                }
        ...
        function check_root_domains_match(a, b) {
            var _c7 = a.split(".");
            var _c8 = b.split(".");
            var _c9 = Math.min(_c7.length, _c8.length);
            var _ca = 2;
            if (_c7.length > 1 && ((_c7[_c7.length - 2].length <= 3 && _c7[_c7.length - 1] in {
                    "at": 1,
                    "au": 1,
                    "br": 1,
                    "es": 1,
                    ...
                    "us": 1,
                    "za": 1
                }) || _c7[_c7.length - 1] == "kr" || _c7[_c7.length - 1] == "ru" || (_c7[_c7.length - 1] == "au" && _c7[_c7.length - 2] in {
                    "csiro": 1
                }) || (_c7[_c7.length - 1] == "at" && _c7[_c7.length - 2] in {
                    "priv": 1
                }) || (_c7[_c7.length - 1] == "fr" && _c7[_c7.length - 2] in {
                    "avocat": 1,
                    "aeroport": 1,
                    "veterinaire": 1
                }) || (_c7[_c7.length - 1] == "hu" && _c7[_c7.length - 2] in {
                    "film": 1,
                    "lakas": 1,
                    "ingatlan": 1,
                    "sport": 1,
                    "hotel": 1
                }) || (_c7[_c7.length - 1] == "nz" && _c7[_c7.length - 2] in {
                    "geek": 1,
                    "kiwi": 1,
                    "maori": 1,
                    "school": 1,
                    ...
                    "health": 1,
                    "parliament": 1
                }) || (_c7[_c7.length - 1] == "il" && _c7[_c7.length - 2] in {
                    "muni": 1
                }) || (_c7[_c7.length - 1] == "za" && _c7[_c7.length - 2] in {
                    "school": 1
                }) || (_c7[_c7.length - 1] == "tr" && _c7[_c7.length - 2] in {
                    "name": 1
                }) || (_c7[_c7.length - 1] == "uk" && _c7[_c7.length - 2] in {
                    "police": 1
                }))) {
                _ca = 3
            }
            for (var i = 1; i <= _c9; i++) {
                if (_c7[_c7.length - i] != _c8[_c8.length - i]) {
                    return false
                }
                if (i >= _ca) {
                    return true
            ...
            return _c7.length == _c8.length
        }

        function classify_referrer(_cc, r) {
            if (r == "") {
                return "d"
            }
            var _ce = r.split("/")[2].replace(/^www\./, "");
            var _cf = document.location.host.replace(/^www\./, "");
            if (apply_new_methodology_fixes(_cc)) {
                if (_cf == _ce) {
                    return "internal"
                }
                if (check_root_domains_match(_ce, _cf)) {
                    return "internal"
                }
            }
            ...
            var _d0 = ["utm_source=bing", "?gclid=", "&gclid=", "utm_medium=cpc", "utm_medium=paid-media", "utm_medium=ppc"];
            for (var i = 0; i < _d0.length; i++) {
                if (document.location.search.indexOf(_d0[i]) !== -1) {
                    return "p"
                }
            }
            var _d2 = ["utm_medium=email"];
            ...
            for (var _d3 in _c3) {
                if (_ce.replace(_d3, "#").split(".").indexOf("#") !== -1) {
                    if (_c3[_d3] === null) {
                        return _d3
                    }
                    for (var i = 0; i < _c3[_d3].length; i++) {
                        var _d4 = _c3[_d3][i];
                        if (r.indexOf("?" + _d4 + "=") !== -1 || r.indexOf("&" + _d4 + "=") !== -1) {
                            return _d3
                        }
                    }
                }
            ...
            for (var _d5 in _c4) {
                for (var i = 0; i < _c4[_d5].length; i++) {
                    var _d3 = _c4[_d5][i];
                    if (_ce.replace(_d3, "#").split(".").indexOf("#") !== -1) {
                        return _d5
                    }
        ...
        var _d7 = escape(get_referrer());
        _4.record_pageview = function(_d8, _d9) {
            var _da = "invisible";
            if (typeof _d8 === "undefined") {
                ...
                if (isNaN(_d8)) {
                    ...
                    if (typeof _d9 === "string") {
                        _4._security_codes[_d8] = _d9
                    } else {
                        if (_4._security_codes[_d8] === "undefined") {
                            console.error("Please include the security code for project " + _d8 + " as the second argument to record_pageview");
                            return
                        }
                    }
                }
            ...
            if (_4._security_codes[_d8] === undefined) {
                _4._security_codes[_d8] = ""
            }
            var _db = 0;
            if (_d8 == 4135125 || _d8 == 6169619 || _d8 == 6222332 || _d8 == 5106510 || _d8 == 6311399 || _d8 == 6320092 || _d8 == 5291656 || _d8 == 7324465 || _d8 == 6640020 || _d8 == 4629288 || _d8 == 1480088 || _d8 == 2447031) {
                ...
                if (document.webkitVisibilityState == "prerender") {
                    if (_5 == 1) {
                        function delayed_send_pageview() {
                            if (document.webkitVisibilityState != "prerender") {
                                for (var _dc in _4._security_codes) {
                                    send_pageview(parseInt(_dc, 10), "invisible", {
                                        "p": 2
                                    })
                                }
                    ...
                    gen_counter(_d8, _da, false, {}, {
                        "p": 1
                    })
                } else {
                    send_pageview(_d8, _da, {
                        "p": 0
                    })
                }
            }
        ...
        function send_pageview(_de, _df, _e0) {
            var _e1 = {};
            _e1["u1"] = "za";
            var _e2 = need_project_config(_de);
            _dd[_de] = (new Date()).getTime();
            var _e3 = {};
            if (!apply_new_methodology_fixes(_de)) {
                var _e4 = classify_referrer(_de, _d7);
                var _e5 = categorize_class(_e4);
                if (_e4 != "internal") {
                    _e3["rcat"] = _e5;
                    _e3["rdom"] = _e4
                }
            }
            var _e6 = Math.round((new Date()).getTime() / 1000);
            if (_e != "disabled") {
                if (apply_new_methodology_fixes(_de)) {
                    var _e4 = classify_referrer(_de, _d7);
                    var _e5 = categorize_class(_e4);
                ...
                try {
                    var _e7 = JSON.parse(localStorage.getItem("sc_medium_source"));
                    if (_e7 == null) {
                        _e7 = {}
                    }
                    var _e8 = null;
                    ...
                    var msl = 0;
                    for (var k in _e7) {
                        if (_e8 === null || _e7[k] > _e7[_e8]) {
                            _e8 = k
                        }
                        var _ed = categorize_class(k);
                        if (_e5 == _ed && (_e9 === null || _e7[k] > _e7[_e9])) {
                            _e9 = k
                        }
                        if (_ed == "r" && (_ea === null || _e7[k] < _e7[_ea])) {
                            _ea = k
                        }
                        msl += 1
                    }
                    ...
                    if (_e4 == "d" && _e8 !== null && _e8 != "d" && (_e6 - _e7[_e8]) < 60 * _ee) {
                        _e4 = "internal"
                    }
                    if (apply_new_methodology_fixes(_de)) {
                        if (sessionStorage.getItem("statcounter_session") && (_e6 - parseInt(sessionStorage.getItem("statcounter_session"), 10)) < 60 * 30) {
                            _e4 = "internal"
                        }
                        sessionStorage.setItem("statcounter_session", _e6)
                    }
                    if (!apply_new_methodology_fixes(_de)) {
                        if (_e5 == "r" && sessionStorage.getItem("statcounter_exit_domain") == _e4) {
                            _e4 = "internal"
                        }
                    }
                    if (_e4 == "internal") {
                        if (_e8 !== null) {
                            _e3["rcat"] = categorize_class(_e8);
                            if (_e3["rdom"] !== undefined) {
                                delete _e3["rdom"]
                            }
                            _e3["rdomo"] = _e8;
                            _e3["rdomg"] = _e6 - _e7[_e8];
                            _e7[_e8] = _e6
                        }
                    } else {
                        var _ef = false;
                        if (_e4 in _e7) {
                            ...
                            _e3["rdomg"] = _e6 - _e7[_e4];
                            if (_e6 - _e7[_e4] < 60 * 30) {
                                _ef = true
                            }
                        } else {
                            _e3["rdomg"] = "new"
                        }
                        if (_e3["bb"] === undefined && !_ef) {
                            sessionStorage.setItem("statcounter_bounce", "1");
                            _e3["bb"] = 1
                        }
                        if (_e9 !== null && (!(_e4 in _e7) || _e4 != _e9)) {
                            _e3["rcatg"] = _e6 - _e7[_e9]
                        }
                        _e7[_e4] = _e6
                    }
                    try {
                        localStorage.setItem("sc_medium_source", JSON.stringify(_e7))
                ...
                var _f2 = _4.update_cookie(_de, _e6, _f1);
                if (_f2["session_incremented"]) {
                    var _f3 = _sessionStorageGetConfig("record_" + _de);
                    if (_f3 && !_f3.match(/(^test$|wsdev$|^dev[0-9]*)/)) {
                        _e2 = true;
                        _sessionStorageSetConfig("sc_project_time_difference_" + _de, false)
                    }
                }
                _4._session_increment_calculated[_de] = true;
                _e0["jg"] = _f2["jg"];
                _e0["rr"] = _f2["rr"];
                if (_f2["u1"] !== undefined) {
                    _e1["u1"] = _f2["u1"]
            ...
            if (Object.prototype.toString.call(_4._pending_tags) === "[object Array]") {
                var _f4 = _4._pending_tags.length;
                if (_f4 >= 1) {
                    var _f5 = get_tag_qs(_4._pending_tags[0]);
                    for (var arg in _f5) {
                        _e0[arg] = _f5[arg]
                    }
                }
            ...
            _4._pending_tags = {};
            gen_counter(_de, _df, _e2, _e1, _e0);
            _d7 = get_page_url();
            _b3(_de)
        }

        function gen_counter(_f6, _f7, _f8, _f9, _fa) {
            if (_f6 !== 999) {
                _f9["sc_project"] = _f6
            } else {
                if (window.usr) {
            ...
            _f9["java"] = 1;
            _f9["security"] = _4._security_codes[_f6];
            _f9["sc_snum"] = _5;
            _f9["sess"] = _4.version();
            var _fb = _b;
            if (_f7 == "text") {
            ...
            _fb = _fb.replace("?&", "?");
            _fa["resolution"] = get_screen_width();
            _fa["h"] = get_screen_height();
            _fa["camefrom"] = _d7.substring(0, 600);
            _fa["u"] = get_page_url();
            _fa["t"] = get_page_title();
            if (_f7 == "invisible") {
                _fa["invisible"] = "1"
            } else {
                if (_f7 == "text") {
                    _fa["text"] = window.sc_text
                }
            }
            var _fd = "";
            for (var arg in _fa) {
            ...
            if (_f7 == "invisible") {
                ...
                if (_fe) {
                    try {
                        var _100 = sessionStorage.getItem("statcounter_pending");
                        if (!_100) {
                            var _101 = {}
                        } else {
                            try {
                                var _101 = JSON.parse(_100)
                            } catch (ignore) {
                                var _101 = {}
                            }
                        }
                        if (_101[_f6] === undefined) {
                            _101[_f6] = {}
                        }
                        var now = new Date().getTime();
                        _101[_f6][now] = _fd;
                        while (true) {
                            _100 = JSON.stringify(_101);
                            if (_100 == "{}") {
                                sessionStorage.removeItem("statcounter_pending");
                                break
                            }
                            var _103 = _100.split(/:.{20}/).length - 1;
                            if (_103 < 20) {
                                var _104 = true;
                                try {
                                    sessionStorage.setItem("statcounter_pending", _100)
                                } catch (e) {
                                    if (!e.name || e.name.toLowerCase().replace(/_/g, "").substring(0, 16) !== "quotaexceedederr") {
                                        throw e
                                    }
                            ...
                            var _106 = false;
                            var _107 = false;
                            for (var _108 in _101) {
                                for (var _109 in _101[_108]) {
                                    var _10a = /jg=(\d+)/.exec(_101[_108][_109]);
                                    if (_10a !== null) {
                                        var _10b = parseInt(_10a[1])
                                    } else {
                                        var _10b = false
                                    }
                                    if (_105 === false || (_10b !== false && _10b < _105)) {
                                        if (_10b !== false) {
                                            _105 = _10b
                                        }
                                        _106 = _108;
                            ...
                            delete _101[_106][_107];
                            if (JSON.stringify(_101[_106]) == "{}") {
                                delete _101[_106]
                            }
                        }
                        for (var ts in _101[_f6]) {
                            (function(_10d, _10e) {
                                var _10f = _101[_10e][_10d];

                                function post_hit_pending_cleanup() {
                                    if (_101[_10e] !== undefined) {
                                        delete _101[_10e][_10d];
                                        if (JSON.stringify(_101[_10e]) == "{}") {
                                            delete _101[_10e]
                                        }
                                    }
                                    var _110 = JSON.stringify(_101);
                                    if (_110 == "{}") {
                                        sessionStorage.removeItem("statcounter_pending")
                                    } else {
                                        sessionStorage.setItem("statcounter_pending", _110)
                                    }
                                }
                                var _111 = _fb + _10f;
                                if (_10d != now) {
                                    _111 += "&pg=" + Math.round((now - _10d) / 1000)
                                } else {
                                    _ff = true;
                                    _111 += get_performance_url_params(_f6)
                                }
                                if (_f8) {
                                    config_ping(_f6, _111, function(_112) {
                                        post_hit_pending_cleanup()
                                    })
                                } else {
                                    if (!navigator.sendBeacon) {
                                        var _113 = new Image();
                                        _113.onload = function() {
                                            post_hit_pending_cleanup()
                                        };
                                        _113.src = _111 + "&sc_random=" + Math.random()
                                    } else {
                                        navigator.sendBeacon(_111, "");
                                        post_hit_pending_cleanup()
                                    }
                                }
                            })(parseInt(ts, 10), _f6)
                ...
                if (!_fe || !_ff) {
                    var _114 = _fb + get_performance_url_params(_f6) + _fd;
                    if (_f8) {
                        config_ping(_f6, _114)
                    } else {
                        if (!navigator.sendBeacon) {
                            var _115 = new Image();
                            _115.src = _114 + "&sc_random=" + Math.random()
                        } else {
                            navigator.sendBeacon(_114, "")
                        }
                    }
                }
            } else {
                var _114 = _fb + get_performance_url_params(_f6) + _fd;
                var _116 = "sc_counter_" + _f6;
                if (_5 != 1) {
                    _116 += "_" + _5
                }
                if (_f7 == "text") {
                    if (_f8) {
                        document.writeln("<span class=\"statcounter\" id=\"" + _116 + "\"></span>");
                        config_ping(_f6, _114, function(_117) {
                            document.getElementById(_116).innerHTML = _117["text"]
                        })
                    } else {
                        document.writeln("<scr" + "ipt" + " src=\"" + _114.replace(/&/g, "&amp;") + "\"></scr" + "ipt>")
                    }
                } else {
                    if (window.sc_counter_width && window.sc_counter_height) {
                        var _118 = " width=\"" + sc_counter_width + "\" height=\"" + sc_counter_height + "\""
                    }
                    var _119 = "StatCounter - Free Web Tracker and Counter";
                    ...
                    if (window.sc_remove_link) {
                        ...
                        var _11a = "<a id=\"" + _116 + "\" class=\"statcounter\" href=\"https://www." + _c + "/\" target=\"_blank\">";
                        var _11b = "</a>"
                    }
                    if (_f8) {
                        document.writeln("<span class=\"statcounter\">" + _11a + "Statcounter" + _11b + "</span>");
                        config_ping(_f6, _114, function(_11c) {
                            var _11d = "<img src=\"" + _11c["counter_image"] + "\" alt=\"" + _119 + "\" border=\"0\"" + _118 + ">";
                            document.getElementById(_116).innerHTML = _11d
                        })
                    } else {
                        _114 += "&sc_random=" + Math.random();
                        document.writeln("<span class=\"statcounter\">" + _11a + "<img src=\"" + _114.replace(/&/g, "&amp;") + "\" alt=\"" + _119 + "\" border=\"0\"" + _118 + ">" + _11b + "</span>")
                    }
                }
            }
            _16++
        ...
        function sc_process_anchor(_11e) {
            var _11f = function() {
                for (var _120 in _4._security_codes) {
                    sc_clickstat_call(parseInt(_120, 10), this)
                }
                return true
            };
            if (_11e.addEventListener) {
                _11e.addEventListener("mousedown", _11f)
            } else {
                if (_11e.attachEvent) {
                    _11e.attachEvent("onmousedown", _11f)
                }
            }
        }
        ...
        function sc_clickstat_call(_124, _125) {
            var _126 = "7z|aac|avi|csv|doc|docx|exe|flv|gif|gz|jpe?g|js|mp(3|4|e?g)|mov|pdf|phps|png|ppt|rar|sit|tar|torrent|txt|wma|wmv|xls|xlsx|xml|zip";
            if (typeof(window.sc_download_type) == "string") {
                _126 = window.sc_download_type
            }
            var _127 = "https?|ftp|telnet|ssh|ssl|mailto|spotify|tel";
            var _128 = "ac|co|gov|ltd|me|mod|net|nic|nhs|org|plc|police|sch|com";
            var dl = new RegExp("\\.(" + _126 + ")$", "i");
            var lnk = new RegExp("^(" + _127 + "):", "i");
            var _12b = new RegExp("^(" + _128 + ")$", "i");
            var _12c = location.host.replace(/^www\./i, "");
            var _12d = _12c.split(".");
            var _12e = _12d.pop();
            var _12f = _12d.pop();
            if (_12b.test(_12f)) {
            ...
            _12e = _12f + "." + _12e;
            var _130 = "^https?://(.*)(" + _12e + "|webcache.googleusercontent.com)";
            var _131 = new RegExp(_130, "i");
            if (_125) {
                var _132 = 0;
                if (lnk.test(_125)) {
                    if ((_131.test(_125))) {
                        if (dl.test(_125)) {
                            ...
                            if (window.sc_exit_link_detect && new RegExp(sc_exit_link_detect, "i").test(_125)) {
                                _132 = 2
                            } else {
                                if (_a == 2) {
                                    _132 = 2
                ...
                if (_132 != 0) {
                    var _133 = escape(_125);
                    if (_133.length > 0) {
                        if (!apply_new_methodology_fixes(_124)) {
                            if (_132 == 2 && _e != "disabled") {
                                try {
                                    sessionStorage.setItem("statcounter_exit_domain", _133.split("/")[2].replace(/^www\./, ""))
                                } catch (ignore) {}
                            }
                        }
                        var _134 = _b + "click.gif?sc_project=" + _124 + "&security=" + _4._security_codes[_124] + "&c=" + _133 + "&m=" + _132 + "&u=" + get_page_url() + "&t=" + get_page_title() + "&sess=" + _4.version() + "&rand=" + Math.random();
                        var _135 = Math.round((new Date()).getTime() / 1000);
                        var _136 = _4.update_cookie(_124, _135);
                        if (_136["u1"] !== undefined) {
                            _134 += "&u1=" + _136["u1"]
                        }
                        _134 += "&jg=" + _136["jg"];
                        _134 += "&rr=" + _136["rr"];
                        ...
                        if (_4._add_recording_event) {
                            _4._add_recording_event(_132 == 1 ? "download" : _132 == 2 ? "exit" : "unknown", {
                                "link": unescape(_133)
                            })
                        }
                        sc_delay()
        ...
        function sc_adsense_click(_13e, _13f) {
            if (_13f.src.match(_138)) {
                var _140 = escape(_13f.src)
            } else {
                var _140 = escape("Google Adsense " + _13f.width + "x" + _13f.height)
            }
            var _141 = _b + "click.gif?sc_project=" + _13e + "&security=" + _4._security_codes[_13e] + "&c=" + _140 + "&m=2&u=" + get_page_url() + "&t=" + get_page_title() + "&sess=" + _4.version() + "&rand=" + Math.random();
            var _142 = Math.round((new Date()).getTime() / 1000);
            var _143 = _4.update_cookie(_13e, _142);
            if (_143["u1"] !== undefined) {
                _141 += "&u1=" + _143["u1"]
            }
            _141 += "&jg=" + _143["jg"];
            _141 += "&rr=" + _143["rr"];
        ...
        function sc_adsense_init() {
            var _145 = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
            var _146 = /Firefox/.test(navigator.userAgent) && /Android/.test(navigator.userAgent);
            if (_7 && (_145 || _146)) {
                var el = document.getElementsByTagName("iframe");
                for (var i = 0; i < el.length; i++) {
                    if (el[i].id.substring(0, 6) == "aswift") {
                        el[i].addEventListener("mouseenter", function(e) {
                            for (var _14a in _4._security_codes) {
                                sc_adsense_click(parseInt(_14a, 10), this)
                            }
                        })
                    }
                }
                    ...
                    if (typeof window.addEventListener !== "undefined") {
                        ...
                        if (_7) {
                            ...
                            window.addEventListener("blur", function() {
                                var _14d = document.activeElement;
                                _13c = _14d;
                                _13d = new Date().getTime()
                            })
                        }
                        window.addEventListener(_14c, sc_exitpage, false);
        ...
        function sc_exitpage(e) {
            ...
            if (typeof _13a != "undefined") {
                for (var i = 0; i < ad.length; i++) {
                    var _15a = sc_findx(ad[i]);
                    var _15b = sc_findy(ad[i]);
                    var adW = parseInt(_15a, 10) + parseInt(ad[i].width, 10) + 15;
                    var adH = parseInt(_15b, 10) + parseInt(ad[i].height, 10) + 10;
                    var _15e = (_13a > (_15a - 10) && _13a < adW);
                    var _15f = (_13b > (_15b - 10) && _13b < adH);
                    if (_15f && _15e) {
                        if (ad[i].src.match(_138) || ad[i].id.match(_139)) {
                            for (var _160 in _4._security_codes) {
                                sc_adsense_click(parseInt(_160, 10), ad[i])
                            }
                        }
                    }
                }
            ...
            if (_7) {
                if (typeof _13c != "undefined" && _13c.id.substring(0, 6) == "aswift") {
                    var _161 = new Date().getTime() - _13d;
                    if (_161 < 300) {
                        for (var _160 in _4._security_codes) {
                            sc_adsense_click(parseInt(_160, 10), _13c)
                        }
                    }
                }
            }
        ...
        function initiate_click_detection() {
            var _162 = document.getElementsByTagName("a");
            var _163 = document.getElementsByTagName("area");
            for (var i = 0; i < _162.length; i++) {
                var _165 = _162[i];
                sc_process_anchor(_165)
            }
            for (var i = 0; i < _163.length; i++) {
                var _165 = _163[i];
                if (typeof _165.hasAttribute === "function" && _165.hasAttribute("href")) {
                    sc_process_anchor(_165)
                }
            }
            if (typeof window.addEventListener != "undefined") {
        ...
        _4.update_cookie = function(_167, _168, _169) {
            if (_168 === undefined) {
                _168 = Math.round((new Date()).getTime() / 1000)
            }
            var _16a = _sessionStorageGetConfig("sc_project_time_difference_" + _167);
            var ret = {};
            var _16c = "1.1.1.1.1.1.1.1.1";
            var _16d = "is_visitor_unique";
            try {
                var _16e = getLocal(_16d, _167)
            } catch (e) {
                var _16e = false;
                _d = ".ex"
            }
            var _16f = [];
            var _170 = [];
            if (_16e && _16e.substring(0, 2) == "rx") {
                removeLocal(_16d, _83);
                var _171 = _16e.substring(2);
                _16f = _171.split("-");
                var _172 = false;
                var _173 = false;
                for (var i = 0; i < _16f.length; i++) {
                    var _175 = _16f[i].split(".");
                    if (parseInt(_175[0], 10) == _167) {
                        _172 = true;
                        var _176 = parseInt(_175[1], 10);
                        _4._returning_values[_167] = [];
                        var _177 = 2;
                        if (_175[2].length == 32) {
                            _d = "." + _175[2];
                            _177 = 3
                        ...
                        for (var ir = 0; ir < _14.length; ir++) {
                            var rval = parseInt(_175[ir + _177], 10);
                            if (isNaN(rval)) {
                                rval = 1
                            }
                            _4._returning_values[_167].push(rval)
                        }
                        ret["jg"] = _168 - _176;
                        for (var ir = 0; ir < _14.length; ir++) {
                            if (_169) {
                                _4._returning_values[_167][ir]++
                            } else {
                                if (_168 > (_176 + 60 * _14[ir])) {
                                    if (_14[ir] * 60 === _16a) {
                        ...
                        ret["rr"] = _4._returning_values[_167].join(".");
                        _170.push("" + _167 + "." + _168 + _d + "." + _4._returning_values[_167].join("."))
                    } else {
                        _170.push(_16f[i]);
                        if (i == 0 && _175[2].length == 32 && _d == "") {
                            _d = "." + _175[2]
                        }
                    }
                    if (i == 0) {
                ...
                if (!_172) {
                    ...
                    _170.push("" + _167 + "." + _168 + _d + "." + _16c);
                    _4._returning_values[_167] = _16c.split(".");
                    ret["jg"] = "new";
                    ret["rr"] = _16c
                }
                _170.sort(function(a, b) {
                    return parseInt(b.split(".")[1], 10) - parseInt(a.split(".")[1], 10)
                });
                for (var iv = 1; iv < _170.length; iv++) {
                    _170[iv] = _170[iv].replace("." + _170[0].split(".")[2] + ".", ".")
                }
                var _17d = setLocal(_16d, _170, _83, "rx", 3, _167);
                if (!_17d) {}
            } else {
                if (_d != ".ex") {
                    _d = "." + generate_uuid();
                    _170 = ["" + _167 + "." + _168 + _d + "." + _16c];
                    var _17e = setLocal(_16d, _170, _83, "rx", 3, _167);
                    if (_17e) {
                        _4._returning_values[_167] = _16c.split(".");
                        ret["jg"] = "new";
                        ret["rr"] = _16c
        ...
        _4.get_session_num = function(_17f) {
            var _180 = _sessionStorageGetConfig("sc_project_time_difference_" + _17f);
            if (_180 != false && _4._session_increment_calculated[_17f] && _4._returning_values[_17f].length == _14.length) {
                for (var i = 0; i < _14.length; i++) {
                    if (_14[i] * 60 == parseInt(_180)) {
                        return _4._returning_values[_17f][i]
                    }
                }
            }
        ...
        _4.get_tab_session = function() {
            var _182 = false;
            try {
                _182 = sessionStorage.getItem("statcounter_tab_session");
                if (!_182) {
                    _182 = generate_uuid(8);
                    try {
                        sessionStorage.setItem("statcounter_tab_session", _182)
                    } catch (e) {
                        _182 = false
                    }
                }
        ...
        _4.record = function(_183, _184) {
            if (_184 === undefined) {
                _184 = "on"
            } else {}
            if (_183 === undefined || _183 === "on" || _183 === "dev") {
                if (_2 !== false) {
                ...
                if (parseInt(_183, 10) + "" == _183) {
                    _183 = parseInt(_183, 10)
                } else {
                    return
                }
            }
            _sessionStorageSetConfig("record_" + _183, _184);
            _b3(_183)
        };
        ...
        if (_5 == 1) {
            ...
            try {
                var _185 = document.getElementsByTagName("title");
                if (_185.length) {
                    var _186 = document.title;
                    var _187 = document.location.href.split("#")[0];
                    var _188 = new MutationObserver(function() {
                        var _189 = document.location.href.split("#")[0];
                        if (document.title != _186 && _189 != _187) {
                            for (var _18a in _4._security_codes) {
                                var _18b = parseInt(_18a, 10);
                                if (_dd[_18b] === undefined || (new Date().getTime() - _dd[_18b] > 1000)) {
                                    setTimeout(function(_18c) {
                                        if (_dd[_18c] === undefined || (new Date().getTime() - _dd[_18c] > 1000)) {
                                            _4.record_pageview(_18c)
                                        }
                                    }, 200, _18b)
                                }
                            }
